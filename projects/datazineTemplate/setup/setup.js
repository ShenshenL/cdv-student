...
function init(){
  ...
  <div id="nav-wrapper">
    ...
    <nav id="page-nav"><a class="button `+ checkPage('cover') +`>Cover</a><a class="button `+ checkPage('middlespread') +`" href="middlespread.html">Page 2 & 3</a><a class="button `+ checkPage('back') +`" href="back.html">Back</a></nav>
  </div>
  `;
